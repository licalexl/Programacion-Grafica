...
public class Piramide3 : MonoBehaviour
{
    ...
    Vector3[] vertices = {
                           //piramide
                           new Vector3(-0.5f, Mathf.Sqrt(6)/3, Mathf.Sqrt(3)*2.5f/3),//3 d
                           new Vector3(-0.5f, 0, Mathf.Sqrt(3)/2),//0 a
                           new Vector3(0, 0, Mathf.Sqrt(3)),//1 b
                           new Vector3(-0.5f, Mathf.Sqrt(6)/3, Mathf.Sqrt(3)*2.5f/3),//3 d
                           new Vector3(-1, 0, Mathf.Sqrt(3)),//2 c
                           new Vector3(-0.5f, Mathf.Sqrt(6)/3, Mathf.Sqrt(3)*2.5f/3),//3 d
                                                                    };
    int[] triangles = {
                        //piramide
